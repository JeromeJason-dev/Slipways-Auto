...
export const Register = () => {
  ...
  const handleUserRedirect = (email) => {
    if (email?.endsWith('@slipways.com')) {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      // Redirect based on the Google account's email domain
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Redirect based on the newly registered email
      handleUserRedirect(formData.email);
    } catch (err) {
